import { getApiBaseUrl, isNativeApp } from './apiClient.js'
...
export function resolveCollectConfig(env = {}) {
  ...
  const nativeApiBaseUrl = isNativeApp() ? getApiBaseUrl() : ''
  ...
  return {
    collectBaseUrl: configuredCollectBaseUrl === 'same-origin'
      ? nativeApiBaseUrl || browserOrigin || DEFAULTS.collectBaseUrl
      : configuredCollectBaseUrl || nativeApiBaseUrl || DEFAULTS.collectBaseUrl,
    ...
    tavernBaseUrl: configuredTavernBaseUrl === 'same-origin'
      ? nativeApiBaseUrl || browserOrigin
      : configuredTavernBaseUrl || nativeApiBaseUrl || browserOrigin,
  }
}
